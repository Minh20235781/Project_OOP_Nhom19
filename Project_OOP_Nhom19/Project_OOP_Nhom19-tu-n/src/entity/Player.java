...
public class Player extends Entity {
    ...
    public BufferedImage playerImageSetup(String imageName){
        ...
        try{
            resizedImage = ImageIO.read(getClass().getResourceAsStream("/player_huster/"+imageName+".png"));
    ...
    public void getPlayerImage() {
            ...
            left6 = playerImageSetup("run_left_40x40_1");
            ...
            right5 = playerImageSetup("run_right_40x40_1");
            right6 = playerImageSetup("run_right_40x40_2");
    }


    public void getPlayerAttackImage(){
        attackUp0=playerImageSetup("attack/attackup_1-49");
        attackUp1=playerImageSetup("attack/attackup_2-50");
        attackUp2=playerImageSetup("attack/attackup_3-51");
        attackUp3=playerImageSetup("attack/attackup_4-52");
        attackUp4=playerImageSetup("attack/attackup_5-53");
        attackUp5=playerImageSetup("attack/attackup_6-54");
        attackUp6=playerImageSetup("attack/attackup_1-49");

        attackDown0=playerImageSetup("attack/attackdown_0-31");
        attackDown1=playerImageSetup("attack/attackdown_1-32");
        attackDown2=playerImageSetup("attack/attackdown_2-33");
        attackDown3=playerImageSetup("attack/attackdown_3-34");
        attackDown4=playerImageSetup("attack/attackdown_4-35");
        attackDown5=playerImageSetup("attack/attackdown_5-36");
        attackDown6=playerImageSetup("attack/attackdown_0-31");

        attackLeft0=playerImageSetup("attack/attackleft_1-37");
        attackLeft1=playerImageSetup("attack/attackleft_2-38");
        attackLeft2=playerImageSetup("attack/attackleft_3-39");
        attackLeft3=playerImageSetup("attack/attackleft_4-40");
        attackLeft4=playerImageSetup("attack/attackleft_5-41");
        attackLeft5=playerImageSetup("attack/attackleft_6-42");
        attackLeft6=playerImageSetup("attack/attackleft_1-37");

        attackRight0=playerImageSetup("attack/attackright_1-43");
        attackRight1=playerImageSetup("attack/attackright_2-44");
        attackRight2=playerImageSetup("attack/attackright_3-45");
        attackRight3=playerImageSetup("attack/attackright_4-46");
        attackRight4=playerImageSetup("attack/attackright_5-47");
        attackRight5=playerImageSetup("attack/attackright_6-48");
        attackRight6=playerImageSetup("attack/attackright_1-43");
